...
Сегодня узнал, что сейчас в формате ввода автомата `.dot` **важно вводить состояния с 0**, иначе не какие-то операции в духе минимизации и детерминизации могут не работать.
